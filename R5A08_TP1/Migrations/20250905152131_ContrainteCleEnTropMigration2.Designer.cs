...
namespace R5A08_TP1.Migrations
{
    ...
    [Migration("20250905152131_ContrainteCleEnTropMigration2")]
    partial class ContrainteCleEnTropMigration2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("R5A08_TP1.Models.EntityFramework.Produit", b =>
                {
                    ...
                    b.Property<int?>("MarqueNavigationIdMarque")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("TypeProduitNavigationIdTypeProduit")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MarqueNavigationIdMarque");

                    b.HasIndex("TypeProduitNavigationIdTypeProduit");
            ...
            modelBuilder.Entity("R5A08_TP1.Models.EntityFramework.Produit", b =>
                {
                    b.HasOne("R5A08_TP1.Models.EntityFramework.Marque", "MarqueNavigation")
                        ...
                        .HasForeignKey("MarqueNavigationIdMarque")
                    ...
                    b.HasOne("R5A08_TP1.Models.EntityFramework.TypeProduit", "TypeProduitNavigation")
                        ...
                        .HasForeignKey("TypeProduitNavigationIdTypeProduit")
